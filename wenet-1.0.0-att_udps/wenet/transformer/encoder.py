...
from wenet.transformer.attention import RelPositionMultiHeadedAttentionWithoutUV
from wenet.transformer.attention import SimiMultiHeadedAttention
from wenet.transformer.attention import SimiRelPositionMultiHeadedAttentionWithoutUV
...
class ConformerEncoder(BaseEncoder):
    ...
    def __init__(
        ...
        if pos_enc_layer_type == "rel_pos":
            encoder_selfattn_layer = SimiRelPositionMultiHeadedAttentionWithoutUV
        else:
