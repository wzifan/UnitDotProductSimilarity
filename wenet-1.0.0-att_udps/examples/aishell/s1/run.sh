...
decode_modes="ctc_greedy_search attention attention_rescoring"
...
if [ ${stage} -le 0 ] && [ ${stop_stage} -ge 0 ]; then
    ...
    for x in train train_sp dev test; do
...
if [ ${stage} -le 7 ] && [ ${stop_stage} -ge 7 ]; then
  ...
  ./tools/decode.sh --nj 16 \
    --warmup 30 --acoustic_scale 1.5 --beam 15.0 --lattice_beam 10.0 --max_active 7000 \
    --blank_skip_thresh 0.99 --ctc_weight 0.5 --rescoring_weight 0.5 \
